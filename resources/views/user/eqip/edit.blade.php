...
@section('title', 'Изменение оборудования')
                ...
                <form action="" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control form-control-lg" name="name" id="name"
                            value="{{ old('name', $eqip->name) }}" placeholder="Введите название" required>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control form-control-lg" name="description" id="description" rows="4"
                            placeholder="Введите описание" required>{{ old('description', $eqip->description)
                            }}</textarea>
